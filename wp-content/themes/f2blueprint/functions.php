...
<?php
    ...
    function f2_blueprint_files() {
        ...
        if (strstr($_SERVER['SERVER_NAME'], 'portugueseasso.local')) {
            ...
            wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.3a672b099833ef16e434.js'), NULL, '1.0', true);
            wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.3a672b099833ef16e434.css'));
        }
