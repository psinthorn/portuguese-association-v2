...
<?php
    ...
    function f2_blueprint_files() {
        ...
        if (strstr($_SERVER['SERVER_NAME'], 'portugueseasso.local')) {
            ...
            wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.07763ed2cd21b11b7c9a.js'), NULL, '1.0', true);
            wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.07763ed2cd21b11b7c9a.css'));
        }
